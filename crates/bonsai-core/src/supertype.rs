...
// TODO: QueryFileProvider — loads supertype relationships from `.scm` query files.
// This will be needed for grammars that lack built-in supertype information.
// Implementation deferred until we encounter such grammars.
